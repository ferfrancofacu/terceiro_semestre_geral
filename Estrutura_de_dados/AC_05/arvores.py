...
a30= {'raiz':30,'direita':{},'esquerda':{}}
arvore100['esquerda']=a30

a40= {'raiz':40,'direita':{},'esquerda':{}}
arvore100['esquerda']['direita']=a40

a110= {'raiz':110,'direita':{},'esquerda':{}}
arvore100['direita']=a110
...
def insere(arvore,elemento):
    modelo = { 'raiz': elemento, 'direita': {}, 'esquerda': {} }
...
def conta(arvore):
    if raiz(arvore) == 'nao tem raiz':
        return 0
    esq = conta(arvore['esquerda'])
    direit = conta(arvore['direita'])
    total = 1 + esq + direit
    #print(total)
    return total
...
def soma(arvore):
    ...
    direit = soma(arvore['direita'])
    rai = arvore['raiz']
    total = esq + direit + rai
    #print(total)
    return total 
